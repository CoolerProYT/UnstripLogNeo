...
public final class RuntimeConfigAccess {
    ...
    public static Item barkItem() {
        ...
        return BuiltInRegistries.ITEM.getValue(Identifier.parse(UnstripLogConfig.CONFIG.getConfiguredItemId()));
    }
    ...
    private static boolean useSyncedSnapshot() {
        return SyncedConfigState.hasSnapshot() && FMLEnvironment.getDist() == Dist.CLIENT;
    }
